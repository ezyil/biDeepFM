...
def biPNN(feature_dim_dict, embedding_size=8, dnn_hidden_units=(128, 128), l2_reg_embedding=1e-5, l2_reg_dnn=0,
        init_std=0.0001, seed=1024, dnn_dropout=0, dnn_activation='relu',
        use_inner=True, use_outter=True, kernel_type='mat', task='binary'):
    """Instantiates the Multi-objective Product-based Neural Network architecture.
    ...
    output_1 = PredictionLayer(task)(deep_logit_1)
