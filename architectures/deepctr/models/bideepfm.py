...
def biDeepFM(feature_dim_dict, embedding_size=8,
             ...
             only_dnn=False):
    """Instantiates the biDeepFM Network architecture.
    ...
    :param only_dnn: bool, use DNN part only or not
    ...
    if only_dnn == False:
        ...
        if len(dnn_hidden_units) > 0 and use_fm == False:  # only Deep
            final_logit = deep_logit
            final_logit_1 = deep_logit_1
        else:
            raise NotImplementedError
